...
def image_code(code, ax, default_url="./data/default.png"):
    ...
    try:
        ...
        # code non trouvé ou conversion impossible → ignorer ou image par défaut
        if default_url:
            image = Image.open(urllib.request.urlopen(default_url))
            ax.imshow(image)
        ax.axis('off')
