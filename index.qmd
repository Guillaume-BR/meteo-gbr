...
from modules.icons import image_code
...
for i in range(4):
    ...
    df_day.iloc[5,i] = str(value) + ' km/h'
...
for i in range(ncols):
    ...
    image_code(df_day.iloc[1,i], ico_ax)
...
for i in range(ncols):
    ...
    if isinstance(pluie[i], float) and pluie[i]>= 0:
